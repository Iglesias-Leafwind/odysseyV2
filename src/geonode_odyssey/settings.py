...
try:
    from geonode_odyssey.local_settings import *
...
#
PROJECT_NAME = 'geonode_odyssey'

# add trailing slash to site url. geoserver url will be relative to this
if not SITEURL.endswith('/'):
    SITEURL = '{}/'.format(SITEURL)

SITENAME = os.getenv("SITENAME", 'geonode_odyssey')
...
if PROJECT_NAME not in INSTALLED_APPS:
    INSTALLED_APPS += (PROJECT_NAME,'archaeology','django_countries','crispy_forms','django_select2','djgeojson')
